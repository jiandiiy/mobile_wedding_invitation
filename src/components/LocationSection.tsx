...
const TRANSPORT_ITEMS = [
  {
    label: '지하철',
    descriptions: ['2호선 강변역 1, 2번출구 도보 5분거리 (강변테크노마트 판매동 B1 연결)'],
  },
  {
    label: '버스',
    descriptions: [
      '광진01, 광진03, 광진04, 광진05, 강동01, 1, 1-1, 1-3, 9, 9-1, 11, 13, 13-2, 15, 78, 91, 92, 93, 95, 96, 97, 100, 112-1, 1006, 1112, 1113, 1113-1, 1113-2, 1117, 1650, 1660, 2000-1, 2000-3, 2224, M2352, 3212, 3214, 5600, 5700A, 5700B, 6705, 9304번 이용가능',
    ],
  },
  {
    label: '자가용 이용시',
    descriptions: [
      '내비게이션 검색: 웨딩스퀘어 강변 또는 테크노마트 강변',
      '주차: 강변 테크노마트 건물 내 지하주차장 이용(2시간 무료)',
    ],
  },
];
